...
export const KanbanPositionTester: React.FC = () => {
  const [tasks, setTasks] = useState<Omit<Task, 'created_at' | 'updated_at'>[]>([
    { id: 'task1', column_id: 'todo', title: 'Design Homepage', position: 1000 },
    { id: 'task2', column_id: 'todo', title: 'Create API', position: 2000 },
    { id: 'task3', column_id: 'todo', title: 'Write Tests', position: 3000 },
    { id: 'task4', column_id: 'progress', title: 'Setup Database', position: 1000 },
    { id: 'task5', column_id: 'progress', title: 'Deploy App', position: 2000 },
    { id: 'task6', column_id: 'done', title: 'Project Setup', position: 1000 },
  ]);
